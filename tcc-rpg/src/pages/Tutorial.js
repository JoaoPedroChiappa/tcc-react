...
const Tutorial = () => {
  ...
  <div>
    <h1>Tutorial Page</h1>
    <p>
      Guia para Iniciantes: Como Jogar RPG de Mesa 
      <br /><br />
      O RPG de mesa é um jogo de interpretação e narrativa onde os jogadores assumem o papel de personagens fictícios em um mundo imaginário. O jogo é conduzido por um mestre ou narrador, que descreve o ambiente e os desafios, enquanto os jogadores tomam decisões e interagem com o mundo ao redor. Se você é um iniciante interessado em aprender a jogar RPG de mesa, este guia irá ajudá-lo a dar os primeiros passos nessa emocionante aventura.
      <br /><br />
      Passo 1: Escolha de Sistema e Tema
      ...
      <br /><br />
      Passo 3: Conhecendo as Regras Básicas
      ...
      <br /><br />
      Passo 5: Aventurando-se no Mundo do RPG
      ...
      <br /><br />
      Passo 6: Desenvolvimento do Personagem
